    ...
    <section className="flex items-center justify-center">
      <div className="w-3/5 space-y-4">
        ...
        <p>
          ...
          these ingredients on your skin. Always check the ingredient list
          before applying any products on your body or skin, and if you are
          unsure, always consult a dermatologist or doctor.
        </p>
        <div>
